      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const command = lastUserMsg?.info.role === "user" ? lastUserMsg.info.command : undefined
            const promptOps = yield* ops()
...
You should build your plan incrementally by writing to or editing this file. NOTE that this is the only file you are allowed to edit - other than this you are only allowed to take READ-ONLY actions.
    ...
    const command = Effect.fn("SessionPrompt.command")(function* (input: CommandInput) {
      ...
      if (cmd.name === "prompt") {
        ...
        let modelRef = input.model ? Provider.parseModel(input.model) : yield* currentModel(input.sessionID)
        ...
        const reminder = (() => {
          ...
          if (!flags.experimentalPlanMode) return PROMPT_PLAN
