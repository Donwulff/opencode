...
export const Provider = z
  .object({
    ...
    system_prompt: z.string().optional().describe("Custom system prompt to use for all models from this provider"),
    autodiscover: z
      .boolean()
      .optional()
      .describe(
...
export const Info = z
  .object({
    ...
    enterprise: z
      ...
      .optional(),
    security: SecurityConfig.optional().describe("Security configuration for audit logging and network controls"),
    provenance: z
      .object({
        enabled: z.boolean().optional().describe("Enable provenance logging"),
        path: z.string().optional().describe("Custom path for provenance log file"),
        preview_chars: z.number().int().positive().optional().describe("Max characters to include in data previews"),
      })
      .optional()
      .describe("Provenance logging configuration"),
    compaction: z
      .object({
